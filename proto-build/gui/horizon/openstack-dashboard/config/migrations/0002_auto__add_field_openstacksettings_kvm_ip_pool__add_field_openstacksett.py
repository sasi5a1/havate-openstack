...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OpenstackSettings.kvm_ip_pool'
        db.add_column(u'config_openstacksettings', 'kvm_ip_pool',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'OpenstackSettings.kvm_ip_pool_size'
        db.add_column(u'config_openstacksettings', 'kvm_ip_pool_size',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OpenstackSettings.kvm_ip_pool'
        db.delete_column(u'config_openstacksettings', 'kvm_ip_pool')

        # Deleting field 'OpenstackSettings.kvm_ip_pool_size'
        db.delete_column(u'config_openstacksettings', 'kvm_ip_pool_size')
