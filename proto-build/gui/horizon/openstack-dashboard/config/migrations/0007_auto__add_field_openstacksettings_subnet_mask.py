...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OpenstackSettings.subnet_mask'
        db.add_column(u'config_openstacksettings', 'subnet_mask',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OpenstackSettings.subnet_mask'
        db.delete_column(u'config_openstacksettings', 'subnet_mask')
    ...
    models = {
        ...
        u'config.openstacksettings': {
            ...
            'subnet_mask': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
