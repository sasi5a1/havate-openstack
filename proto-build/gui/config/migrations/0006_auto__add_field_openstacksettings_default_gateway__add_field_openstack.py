...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OpenstackSettings.default_gateway'
        db.add_column(u'config_openstacksettings', 'default_gateway',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'OpenstackSettings.dns'
        db.add_column(u'config_openstacksettings', 'dns',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OpenstackSettings.default_gateway'
        db.delete_column(u'config_openstacksettings', 'default_gateway')

        # Deleting field 'OpenstackSettings.dns'
        db.delete_column(u'config_openstacksettings', 'dns')
    ...
    models = {
        ...
        u'config.openstacksettings': {
            ...
            'default_gateway': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'dns': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
