...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NodeSettings.node_number'
        db.add_column(u'config_nodesettings', 'node_number',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NodeSettings.node_number'
        db.delete_column(u'config_nodesettings', 'node_number')
